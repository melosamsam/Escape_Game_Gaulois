...
public class StaffPlaced : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            isOccupied = true;
            UnityEngine.Debug.Log("Staff_to_move dropped on the Socket_staff!");
        }
    }
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.CompareTag("Staff") && !isOccupied)
        {
            UnityEngine.Debug.Log("Staff_to_move removed from the Socket_staff!");
        }
    }
}

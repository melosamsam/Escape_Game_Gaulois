...
public class RingPlaced : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            isOccupied = true;
            UnityEngine.Debug.Log("Ring_to_move dropped on the Socket_staff!");
        }
    }
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.CompareTag("Ring") && !isOccupied)
        {
            UnityEngine.Debug.Log("Ring_to_move removed from the Socket_staff!");
        }
    }
}
